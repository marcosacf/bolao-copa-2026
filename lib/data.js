...
export const DATAS_JOGOS = {
  ...
  M97:{data:'2026-07-09',hora:'17:00'},M98:{data:'2026-07-10',hora:'16:00'},M99:{data:'2026-07-11',hora:'18:00'},M100:{data:'2026-07-11',hora:'22:00'},
...
function _propagateMM(slots, winnerFn) {
  FASES_MM.forEach(k => {
...
function slotsFromOficiais(oficiais) {
...
function slotsFromPalpites(palpites) {
...
export function calcularPontos(nome, palpites, extrasP, oficiais, regras) {
  ...
  try {
    ...
    const slotsPal = slotsFromPalpites(palpites);
